...
interface PaymentFormPaymentProps {
  formData: FormData;
  setFormData: React.Dispatch<React.SetStateAction<FormData>>;
  errors: FormErrors;
}

function PaymentFormPayment({ formData, setFormData, errors }: PaymentFormPaymentProps) {
  return (
    <div className="payment__method-container">
      ...
      <div className="payment__method-button-container">
        <button
          onClick={() => setFormData({ ...formData, paymentMethod: 'left' })}
          className={`payment__method ${formData.paymentMethod === 'left' ? 'left' : ''}`}
        >
        ...
        <button
          onClick={() => setFormData({ ...formData, paymentMethod: 'right' })}
          className={`payment__method ${formData.paymentMethod === 'right' ? 'left' : ''}`}
        >
          Оплата картой
          <br />
          на сайте
      ...
      <div className="payment__method-checkbox-container">
        <input
          ...
          type="checkbox"
          className="payment__method-checkbox"
          checked={formData.checkbox}
        />
        <label className="payment__method-checkbox-label">

                ...
                <div className="header__content-container">
                    <div className="header__top-container">
                        ...
                        <div className="header__information-block">
                            <p className="number">8 920 999 43 50</p>
                        ...
                        <nav className="header__nav-container">
                            <form >
                                <ul className="header__list">
                                    <li className="header__list-item"><button className='header__list-item-btn'>Каталог</button></li>
                                    <li className="header__list-item"><button className='header__list-item-btn'>О проекте</button></li>
                                    <li className="header__list-item"><button className='header__list-item-btn'>Птицы</button></li>
                                    <li className="header__list-item"><button className='header__list-item-btn'>Пожертвования</button></li>
                                </ul>
                            </form>
                        </nav>

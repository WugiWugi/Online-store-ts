...
const birds = [[pigeon, 'Голубь'], [sparrow, 'Воробей'], [martin, 'Ласточка'], [starling, 'Скворец']]
...
export const data = {
  readyMixes: [{
    ...
    description: 'Корм для птиц', prise: 228,
    weight: weight,
    basket: basket,
    detailedDescription: (
  ...
  typesFeed: [{ nameProducts: 'Отдельные виды кормов', src: grainJpg, alt: 'types of feed img', nameProduct: (<>Корм для птиц RIO<br />Линька</>), description: 'для волнистых попугайчиков', prise: 228, weight: weight, basket: basket }],
  feeders: [{ nameProducts: 'Кормушки', src: feedersJpg, alt: 'feeders img', nameProduct: (<>Комплект-агро<br />"Избушка на курьих<br />ножках"</>), description: 'Кормушка малая', prise: 1000, weight: weight, basket: basket }],
